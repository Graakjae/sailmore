...
export default function TripPage() {
  ...
  const fetchTrip = async (tripId) => {
    try {
      const response = await fetch(
        `/backend/phpScripts/getAllTripInfo.php?trip=${tripId}`
      );
  ...
  const fetchImages = async (tripId) => {
    try {
      const response = await fetch(
        `/backend/phpScripts/getImages.php?trip=${tripId}`
      );
      const result = await response.json();
  ...
  const fetchAcceptedCrew = async (tripId) => {
    try {
      const response = await fetch(
        `/backend/phpScripts/acceptedCrew.php?trip=${tripId}`
      );
      if (!response.ok) {
