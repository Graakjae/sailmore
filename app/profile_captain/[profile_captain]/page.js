...
export default function CaptainProfilePage() {
  ...
  const fetchTrip = async () => {
    try {
      const response = await fetch(
        `/backend/phpScripts/getTrip.php/${params.trip}`
      );
  ...
  const fetchProfile = async () => {
    try {
      const response = await fetch(
        `/backend/phpScripts/profile.php/${params.profile_captain}`
      );
      const result = await response.json();
  ...
  const fetchProfileTrips = async () => {
    try {
      const response = await fetch(
        `/backend/phpScripts/profileTrips.php/${params.profile_captain}`
      );
      const result = await response.json();
      console.log("result trips", result);
